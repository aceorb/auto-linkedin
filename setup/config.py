...
custom_profile = "Default" # Empty for Default check Profile with chrome://version
...
phone_number = "9613236364"        # Enter your 10 digit number in quotes Eg: "9876543210"
...
years_of_experience_reactjs = "10"
years_of_experience_angular = "9"
years_of_experience_javascript = "10"
years_of_experience_typecript = "9"
years_of_experience_vue = "8"
years_of_experience_aws = "5"
years_of_experience_frontend = "9"
...
current_city = "Chiapas"                  # If left empty will fill in location of jobs location.

## SOME ANNOYING QUESTIONS BY COMPANIES 🫠 ##
# Address, not so common question but some job applications make it required!
street = "colonia aires del oriente"
state = "Chiapas"
zipcode = "29096"
country = "Mexico"
...
summary = "A Senior Software Engineer specializing in web development. I bring extensive experience across all stages of the development lifecycle for dynamic web projects. With over 8 years of hands-on experience, I have a proven track record of delivering high-quality web applications."

# Your cover letter in quotes, use \n to add line breaks
cover_letter = "A Senior Software Engineer specializing in web development. I bring extensive experience across all stages of the development lifecycle for dynamic web projects. With over 8 years of hands-on experience, I have a proven track record of delivering high-quality web applications."
...
about_company_bad_words = ["Crossover", "Microsoft", "Noir", "CyberCoders", "Jobot"]       # (dynamic multiple search) or leave empty as []. Ex: ["Staffing", "Recruiting", "Name of Company you don't want to apply to"]
...
bad_words = ["Embedded Engineering", "Intership", "Salesforce", "Security Clearance", "Equity Only",  "Equity-Only"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
good_skills = [
    "javascript",
    "react",
    "typescript",
...
skill_match_min_count = 3

check_location_requirement = True
